...
```text
intake-design -> domain workflow -> multipanel-composer if needed -> fig-audit-multipanel-layout if needed -> fig-audit-text-layout -> journal-style-translator -> caption-alttext -> figure-auditor -> export-packager
```
